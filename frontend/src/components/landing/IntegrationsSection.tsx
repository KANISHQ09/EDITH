...
const INTEGRATIONS: IntegrationItem[] = [
  ...
  },
  {
    ...
    quote: 'EDITH synchronizes audio voice transcripts directly into the #incident-room Slack channel with classified action items and fact badges.',
    author: 'Sarah Chen',
